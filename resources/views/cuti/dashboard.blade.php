...
<body>
  ...
  <div class="main-content">
    ...
    <div class="alert-blue mt-2">
      @if($role == 0)
      <i class="bi bi-info-circle"></i> <b>Catatan:</b> Kamu dapat mengajukan cuti maksimal hingga 7 hari sebelum tanggal cuti yang diinginkan. Pastikan pengajuan dilakukan tepat waktu.
      @elseif($role == 1)
